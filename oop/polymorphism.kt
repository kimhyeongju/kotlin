...
open class baseClass{
    // 상속받은 클래스에서 오버라이드 하려면 선조클래스에서 open으로 정의
    open var name = "base";
...
fun main(args: Array<String>) {
    ...
    obj2.func2();
    obj2.func2("문자열 파라미터");
    obj2.func2("문자열 파라미터", 100);


    // 다음이 가능한지 확인
    println()
var obj3 : baseClass = obj2     // baseclass로 obj3변수 선언 후 childclass의 obj2 대입
    obj3.func1()    // 부모, 자식 중 어느 func1이 호출되는가?
    obj3.func2()
}